...
* :beginner: #048 [Utiliser les opérations primitives](/chapters/BP_048_fr.md)
...
* :beginner: #051 [Priviliégier les fonctions anonymes](/chapters/BP_051_fr.md)
* :o: #052 [Donner des fonctions en paramètre à setTimeout() et setInterval() plutôt que des string](/chapters/BP_052_fr.md)
* :beginner: #053 [Utiliser une boucle au lieu de .forEach() (ou reduce())](/chapters/BP_053_fr.md)
...
* :beginner: #062 [Eviter la ré-écriture des getter / setter natifs](/chapters/BP_062_fr.md)
* :beginner: #063 [Ne pas assigner inutilement de valeur aux variables](/chapters/BP_063_fr.md)
...
* :beginner: #077 [Minifier les fichiers CSS](/chapters/BP_077_fr.md)
* :beginner: #078 [Compresser les librairies CSS et Javascript](/chapters/BP_078_fr.md)
...
* :beginner: #081 [Minifier les fichiers JavaScript](/chapters/BP_081_fr.md)
...
* :beginner: #100 [Mettre en cache le favicon.ico](/chapters/BP_100_fr.md)
