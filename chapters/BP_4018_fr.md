...
Une page d’administration peut être utilisée une fois par an et pourtant importantissime (par exemple une purge de cache qui est utilisée uniquement en cas de mise à jour de référentiel). Dans ce cas, elle est conservée.
