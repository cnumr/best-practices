...
Dans le cas de traitements avec une logique plus ou moins complexe, il est déconseillé de récupérer les données "brutes" et de réaliser toutes les opérations de calcul, transformation ou encore d'aggrégation côté serveur backend voire frontend.
