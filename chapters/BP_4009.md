...
Ce choix peut être déterminé en partie grâce aux analytics s'il y en a qui sont disponibles. Attention cependant au biais du 
...
méconnaissance de l'existence d'alternatives), des utilisateurs sont bloqués sur d'anciennes versions d'Internet Explorer.
...
|-------------------|:-------------------------:|
| de page non testées sur les configurations les plus contraingnantes du contexte projet    |  0 |
