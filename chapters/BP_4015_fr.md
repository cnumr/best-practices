...
Un titre de page, ainsi que son équivalent `<title>` en HTML, adjoints à une balise `<meta name="description">` pertinente doivent être parfaitement en accord avec le contenu de la page associée.
