...
Des services sur le web permettent de réaliser sans se déplacer des démarches administratives, des ouvertures de contrats, des déclarations de sinistres etc...
Beaucoup de ces procédures peuvent être complexes à réaliser ou ne prennent pas en compte des cas particuliers.
Pour valider la connexion à un service bancaire en ligne l'installation d'une application mobile et donc un smartphone peut être exigée.
