...
- You want to know all the points to verify, from wireframe design, during the site mockup phase, to delivering assets to developers ;

## You identify with these statements:

> **DESIGNER** → They have basic knowledge of HTML and CSS, using a theme they will make pretty and respond to their needs or their client's needs (or even embedding more than the identified needs) and "hundreds" of plugins as well as often a page builder.
