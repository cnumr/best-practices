...
updatedAt: 2025-10-03T07:26:10.910Z
language: es
published: true
refType: RWEB
versions:
...
saved_resources:
  ...
  - requests
validations:
  - rule: de tratamientos síncronos que tardan más de un minuto
    maxValue: '0'
---
...
Por ejemplo, recibiendo un correo electrónico o una notificación de que se ha completado la tramitación.
