...
updatedAt: 2025-05-30T09:33:46.123Z
language: fr
published: true
refType: RWEB
versions:
...
saved_resources:
  ...
  - network
validations:
  - rule: de Ko téléchargés inutilement
    maxValue: 5 % du poids total de la page.
---
...
Comparez le nombre de pixels de l’image chargée au nombre de pixels réellement affichés. L’outil yellowlab.tools peut vous y aider.
