...
updatedAt: 2025-05-16T12:10:48.952Z
language: en
published: true
refType: RWEB
versions:
...
validations:
  - rule: >-
      The number of options --skip-log-bin and --disable-log-bin not activated
      in cases where binary logs are not useful is equal to or less than
    maxValue: '0'
---
